...
const EmptyState: React.FC<EmptyStateProps> = ({ title, description, icon, actionLabel, onAction }) => {
  return (
    <div className="text-center py-12 px-6 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center group hover:border-brand-secondary/30 transition-colors">
      ...
      <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-1">{title}</h3>
